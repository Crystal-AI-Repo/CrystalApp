...
if (!nonceId || !targetUrl) {
  ...
  setTimeout(() => {
    ...
    location.href = "http://127.0.0.1:8080/oauth2/authorize?client_id=crystal-app&response_type=code&scope=profile&redirect_uri=http%3A%2F%2Flocalhost%3A5173%2Fauth%2Fconsent"
  }, 1000)
}
